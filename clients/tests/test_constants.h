...
#define PRE_MULVAL_UDT                                      \
    ...
    \n                                                      \
        float2                                              \
        mulval_pre(void* in, uint offset, void* userdata)\n \
    {                                                       \
        \n                                                  \
            USER_DATA* data                                 \
            = ((USER_DATA*)userdata + offset);              \
...
#define PRE_MULVAL_PLANAR                                                    \
    ...
    {                                                                        \
        ...
        \n                                                                   \
            ret.x                                                            \
            = *((float*)inRe + offset) * scalar;                             \
        \n                                                                   \
            ret.y                                                            \
            = *((float*)inIm + offset) * scalar;                             \
        \n return ret;                                                       \
        \n                                                                   \
    }
...
#define PRE_MULVAL_PLANAR_DP                                                  \
    ...
    {                                                                         \
        ...
        \n                                                                    \
            ret.x                                                             \
            = *((double*)inRe + offset) * scalar;                             \
        \n                                                                    \
            ret.y                                                             \
            = *((double*)inIm + offset) * scalar;                             \
        \n return ret;                                                        \
        \n                                                                    \
    }
...
#define PRE_MULVAL_LDS                                                                 \
    ...
    {                                                                                  \
        ...
        \n                                                                             \
            __local float* lds                                                         \
            = (__local float*)localmem + lid;                                          \
        \n                                                                             \
            lds[0]                                                                     \
            = *((float*)userdata + offset);                                            \
        \n                                                                             \
        __synthreads();                                                                \
...
#define POST_MULVAL_PLANAR                                                                                                     \
    void mulval_post(void* outputRe, void* outputIm, size_t outoffset, void* userdata, float fftoutputRe, float fftoutputIm)\n \
    {                                                                                                                          \
        \n float scalar = *((float*)userdata + outoffset);                                                                     \
...
#define POST_MULVAL_PLANAR_DP                                                                                                    \
    void mulval_post(void* outputRe, void* outputIm, size_t outoffset, void* userdata, double fftoutputRe, double fftoutputIm)\n \
    {                                                                                                                            \
        \n double scalar = *((double*)userdata + outoffset);                                                                     \
...
#define POST_MULVAL_LDS                                                                                        \
    void mulval_post(void* output, uint outoffset, void* userdata, float2 fftoutput, __local void* localmem)\n \
    {                                                                                                          \
        \n                                                                                                     \
            uint lid                                                                                           \
            = get_local_id(0);                                                                                 \
        ...
        {                                                                                                      \
            \n                                                                                                 \
                lds                                                                                            \
                = (__local float*)localmem + lid * 4;                                                          \
            \n                                                                                                 \
                lds[0]                                                                                         \
                = *((float*)userdata + lid * 4);                                                               \
            \n                                                                                                 \
                lds[1]                                                                                         \
                = *((float*)userdata + lid * 4 + 1);                                                           \
            \n                                                                                                 \
                lds[2]                                                                                         \
                = *((float*)userdata + lid * 4 + 2);                                                           \
            \n                                                                                                 \
                lds[3]                                                                                         \
                = *((float*)userdata + lid * 4 + 3);                                                           \
            \n                                                                                                 \
        }                                                                                                      \
        \n                                                                                                     \
        __synthreads();                                                                                        \
        \n                                                                                                     \
            lds                                                                                                \
            = (__local float*)localmem + outoffset;                                                            \
...
enum { dimx = 0,
    dimy = 1,
    dimz = 2 };
enum fftw_dim { one_d = 1,
    two_d = 2,
    three_d = 3 };
enum { one_interleaved_buffer = 1,
