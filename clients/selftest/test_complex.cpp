...
void ErrorCheck(size_t N, CT *ref, CT *tst, size_t size = 0) {
  ...
  if (maxRefReal > 0 || maxRefImag > 0 || maxTstReal > 0 || maxTstImag > 0) {
    EXPECT_LE(fabs(maxRefReal - maxTstReal),
              fabs(maxRefReal * MAXVAL_TOLERANCE));
    EXPECT_LE(fabs(maxRefImag - maxTstImag),
...
const TrLen2D Test2DLengths[] = {
    ...
    {1024, 1024}, {3, 3},      {9, 9},       {27, 27},    {81, 81},
    {243, 243},   {729, 729},  {5, 5},       {25, 25},    {125, 125},
    {625, 625},

    {2700, 120},  {625, 288},  {90, 5},      {4, 10125},  {4, 10125},
    {9, 1875},    {576, 576},  {900, 270},   {15625, 25}, {100, 729},
    {120, 729},   {4, 19440},  {100, 16},    {50, 3072},  {10000, 24},
    {10000, 24},  {27648, 36}, {6750, 128},  {38880, 24}, {15, 648},
    {15360, 18},  {15360, 18}, {768, 750},   {16, 720},   {16, 720},
    {16, 720},    {135, 3456}, {80, 8748},   {800, 450},  {3125, 32},
    {1944, 320},  {1296, 486}, {81, 5400},   {81, 5400},  {81, 5400},
    {60, 30},     {1152, 25},  {1152, 25},   {3, 52488},  {1875, 108},
    {1350, 512},  {256, 384},  {27648, 5},   {27648, 5},  {72, 128},
    {72, 128},    {125, 648},  {125, 648},   {150, 50},   {150, 50},
    {150, 50},    {216, 4000}, {24, 8192},   {24, 480},   {9, 73728},
    {675, 1280},  {675, 1280}, {21600, 40},  {21600, 40}, {81, 12000},
    {13122, 10},  {486, 32},   {162, 216},   {5400, 2},   {187500, 2},
    {800, 400},   {8, 2592},   {5184, 30},   {10368, 15}, {160, 810},
    {2, 5120},    {7776, 75},  {6, 7290},    {48600, 2},  {360, 2048},
    {20, 270},    {60, 1500},  {60, 1350},   {1296, 25},  {486, 96},
    {40, 1125},   {92160, 4},  {20, 2250},   {2, 233280}, {10, 2500},
    {5, 40000},   {2560, 72},  {2560, 72},   {2560, 72},  {30, 13500},
    {30, 13500},  {30, 2592},  {30, 2592},   {13500, 30}, {250, 300},
    {250, 300},   {192, 648},  {4, 233280},  {4, 233280}, {288, 1440},
    {576, 1440},  {10368, 4},  {1440, 4},    {1440, 4},   {720, 90},
    {720, 90},    {720, 90},   {27, 18750},  {4000, 32},  {360, 32},
    {10, 22500},  {10, 22500}, {256, 3000},  {81, 12800}, {405, 1944},
    {3, 2304},    {1728, 25},  {3888, 30},   {1536, 432}, {225, 1200},
    {405, 100},   {8000, 96},  {160, 45},    {24, 16000}, {1440, 300},
    {58320, 15},  {128, 2560}, {10, 486},    {15552, 2},  {192, 2000},
    {25000, 20},  {40, 19200}, {40, 19200},  {1000, 625}, {1200, 405},
    {32, 120},    {15360, 10}, {15360, 10},  {4050, 8},   {4050, 8},
    {6, 100},     {625, 480},  {6075, 162},  {864, 972},  {384, 2500},
    {144, 4320},  {40, 12150}, {8, 288},     {8, 288},    {216, 3125},
    {216, 3125},  {2700, 27},  {40000, 12},  {9, 23328},  {480, 432},
    {1500, 480},  {160, 1440}, {10125, 100}, {150, 250},  {120, 200},
    {240, 2},     {262440, 2}, {270, 2000},  {150, 1350}, {150, 1350},
    {150, 810},   {18, 2430},  {60000, 6},   {800, 768},  {324, 12},
    {25, 432},    {25, 432},   {864, 192},   {4, 120000}, {360, 32},
    {32, 450},    {115200, 5}, {4500, 36},   {625, 60},   {625, 1458},
    {432, 1600},  {10, 81920}, {5400, 96},   {12500, 16}, {12500, 16},
    {2430, 216},  {2430, 216}, {81000, 8},   {6, 36864},  {19200, 10},
    {12800, 45},  {15, 1000},  {216, 2880},  {25, 41472}, {1024, 180},
    {1024, 180},  {1024, 180}, {30720, 25},  {192, 972},  {192000, 5},

};

const TrLen3D Test3DLengths[] = {
    {1, 1, 1},     {15, 45, 1280}, {100, 8, 120},  {1600, 5, 108},
    {15, 2, 100},  {25, 288, 128}, {480, 375, 4},  {9, 375, 288},
    {15, 48, 72},  {15, 48, 72},   {2250, 32, 3},  {4050, 25, 10},
    {20, 256, 50}, {24, 60, 15},   {24, 60, 15},   {60, 1152, 4},
    {18, 10, 729}, {270, 45, 50},  {250, 20, 90},  {10, 9, 8},
    {150, 90, 5},  {1728, 5, 8},   {128, 9, 9},    {4, 72900, 3},
    {40500, 6, 2}, {40500, 6, 2},  {216, 24, 30},  {6, 3750, 24},
    {3240, 4, 3},  {45, 24, 810},  {243, 45, 54},  {400, 5, 144},
    {4, 54, 200},  {324, 8, 20},   {3, 270, 320},  {3, 216, 8},
    {6, 96, 120},  {10, 4, 3072},  {16, 3645, 10}, {120, 144, 24},
    {3, 3840, 54}, {12, 500, 120}, {25, 16, 810},  {32, 32, 135},
    {30, 36, 90},  {48, 30, 75},   {1000, 12, 64}, {243, 16, 5},
    {384, 15, 60}, {625, 18, 6},   {15, 324, 60},  {54, 27, 144},
    {9, 8748, 9},  {32, 8, 2250},  {2000, 10, 18}, {18, 5, 1024},
    {750, 9, 36},  {9, 10, 6},     {540, 32, 48},  {6, 3, 40500},
    {300, 9, 225}, {45, 9, 48},    {3, 27, 450},   {2, 864, 162},
    {30, 200, 25}, {9, 720, 100},  {2, 24, 3456},  {2048, 27, 6},
    {30, 64, 10},  {96, 72, 144},  {2, 125, 1500}, {216, 27, 135},
    {2, 360, 90},  {96, 162, 4},   {10, 6, 40},    {9, 24, 270},
    {3, 450, 81},  {405, 32, 10},  {15, 23328, 2}, {320, 10, 180},
    {81, 2400, 2}, {768, 300, 3},  {6, 25, 64},    {10, 5, 50},
    {20, 25, 90},  {64, 15, 3},    {1152, 10, 25}, {12, 7200, 5},
    {6, 150, 12},  {150, 12, 200}, {5, 32, 1875},  {3200, 20, 6},
    {2, 3125, 3},
};
...
class BasicInterface1DBasisTest
    : public BasicInterfaceBasisTest<T, CT>,
...
protected:
  virtual void TestRoutine(size_t N, int dir) {
    ...
    if (dir == -1)
      rocfft_plan_create(&this->p, rocfft_placement_inplace,
                         rocfft_transform_type_complex_forward, prec, 1, length,
                         1, NULL);
    else
      rocfft_plan_create(&this->p, rocfft_placement_inplace,
                         rocfft_transform_type_complex_inverse, prec, 1, length,
                         1, NULL);
...
template <typename T, typename CT, rocfft_precision prec>
class BasicInterface2DBasisTest
    : public BasicInterfaceBasisTest<T, CT>,
...
protected:
  virtual void TestRoutine(size_t N0, size_t N1, int dir) {
    ...
    if (dir == -1)
      rocfft_plan_create(&this->p, rocfft_placement_inplace,
                         rocfft_transform_type_complex_forward, prec, 2, length,
                         1, NULL);
    else
      rocfft_plan_create(&this->p, rocfft_placement_inplace,
                         rocfft_transform_type_complex_inverse, prec, 2, length,
                         1, NULL);
...
template <typename T, typename CT, rocfft_precision prec>
class BasicInterface3DBasisTest
    : public BasicInterfaceBasisTest<T, CT>,
...
protected:
  virtual void TestRoutine(size_t N0, size_t N1, size_t N2, int dir) {
    ...
    if (dir == -1)
      rocfft_plan_create(&this->p, rocfft_placement_inplace,
                         rocfft_transform_type_complex_forward, prec, 3, length,
                         1, NULL);
    else
      rocfft_plan_create(&this->p, rocfft_placement_inplace,
                         rocfft_transform_type_complex_inverse, prec, 3, length,
                         1, NULL);
...
typedef BasicInterface1DBasisTest<double, complex_double,
                                  rocfft_precision_double>
    BasicInterfaceDouble1DBasisTest;
typedef BasicInterface2DBasisTest<double, complex_double,
                                  rocfft_precision_double>
    BasicInterfaceDouble2DBasisTest;
typedef BasicInterface3DBasisTest<double, complex_double,
                                  rocfft_precision_double>
    BasicInterfaceDouble3DBasisTest;

typedef BasicInterface1DBasisTest<float, complex_single,
                                  rocfft_precision_single>
    BasicInterfaceSingle1DBasisTest;
typedef BasicInterface2DBasisTest<float, complex_single,
                                  rocfft_precision_single>
    BasicInterfaceSingle2DBasisTest;
typedef BasicInterface3DBasisTest<float, complex_single,
                                  rocfft_precision_single>
...
INSTANTIATE_TEST_CASE_P(ListParamTest, BasicInterfaceDouble1DBasisTest,
                        ::testing::ValuesIn(Test1DLengths));
INSTANTIATE_TEST_CASE_P(ListParamTest, BasicInterfaceSingle1DBasisTest,
                        ::testing::ValuesIn(Test1DLengths));

INSTANTIATE_TEST_CASE_P(ListParamTest, BasicInterfaceDouble2DBasisTest,
                        ::testing::ValuesIn(Test2DLengths));
INSTANTIATE_TEST_CASE_P(ListParamTest, BasicInterfaceSingle2DBasisTest,
                        ::testing::ValuesIn(Test2DLengths));

INSTANTIATE_TEST_CASE_P(ListParamTest, BasicInterfaceDouble3DBasisTest,
                        ::testing::ValuesIn(Test3DLengths));
INSTANTIATE_TEST_CASE_P(ListParamTest, BasicInterfaceSingle3DBasisTest,
                        ::testing::ValuesIn(Test3DLengths));
