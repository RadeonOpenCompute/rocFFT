    ...
    double scale, bool packed, int deviceId, int platformId, bool printInfo, unsigned profile_count)
{
    ...
    if ((place == rocfft_placement_inplace) && packed && (scale == 1.0) && (inOffset[0] == 0) && (inOffset[1] == 0) && (outOffset[0] == 0) && (outOffset[1] == 0)) {
        ...
        LIB_V_THROW(rocfft_plan_description_set_data_layout(desc, inArrType, outArrType, inOffset, outOffset,
                        3, strides, strides[3], 3, o_strides, o_strides[3]),
...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        desc.add_options()("help,h", "produces this help message")("version,v", "Print queryable version information from the rocfft library")("info,i", "Print queryable information of all the runtimes and devices")("printChosen", "Print queryable information of the selected runtime and device")("platform", po::value<int>(&platformId)->default_value(0), "Select a specific platform id as it is reported by info")("device", po::value<int>(&deviceId)->default_value(0), "Select a specific device id as it is reported by info")("notInPlace,o", "Not in-place FFT transform (default: in-place)")("double", "Double precision transform (default: single)")("transformType,t", po::value<rocfft_transform_type>(&transformType)->default_value(rocfft_transform_type_complex_forward), "Type of transform:\n0) complex forward\n1) complex inverse\n2) real forward\n3) real inverse")("lenX,x", po::value<size_t>(&lengths[0])->default_value(1024), "Specify the length of the 1st dimension of a test array")("lenY,y", po::value<size_t>(&lengths[1])->default_value(1), "Specify the length of the 2nd dimension of a test array")("lenZ,z", po::value<size_t>(&lengths[2])->default_value(1), "Specify the length of the 3rd dimension of a test array")("isX", po::value<size_t>(&iStrides[0])->default_value(1), "Specify the input stride of the 1st dimension of a test array")("isY", po::value<size_t>(&iStrides[1])->default_value(0), "Specify the input stride of the 2nd dimension of a test array")("isZ", po::value<size_t>(&iStrides[2])->default_value(0), "Specify the input stride of the 3rd dimension of a test array")("iD", po::value<size_t>(&iStrides[3])->default_value(0), "input distance between successive members when batch size > 1")("osX", po::value<size_t>(&oStrides[0])->default_value(1), "Specify the output stride of the 1st dimension of a test array")("osY", po::value<size_t>(&oStrides[1])->default_value(0), "Specify the output stride of the 2nd dimension of a test array")("osZ", po::value<size_t>(&oStrides[2])->default_value(0), "Specify the output stride of the 3rd dimension of a test array")("oD", po::value<size_t>(&oStrides[3])->default_value(0), "output distance between successive members when batch size > 1")("scale", po::value<double>(&scale)->default_value(1.0), "Specify the scaling factor ")("iOff0", po::value<size_t>(&iOffset[0])->default_value(0), "Specify the offset for first/only input buffer")("iOff1", po::value<size_t>(&iOffset[1])->default_value(0), "Specify the offset for second input buffer")("oOff0", po::value<size_t>(&oOffset[0])->default_value(0), "Specify the offset for first/only output buffer")("oOff1", po::value<size_t>(&oOffset[1])->default_value(0), "Specify the offset for second output buffer")("batchSize,b", po::value<size_t>(&batchSize)->default_value(1), "If this value is greater than one, arrays will be used ")("profile,p", po::value<unsigned>(&profile_count)->default_value(1), "Time and report the kernel speed of the FFT (default: profiling off)")("inArrType", po::value<rocfft_array_type>(&inArrType)->default_value(rocfft_array_type_complex_interleaved), "Array type of input data:\n0) interleaved\n1) planar\n2) real\n3) hermitian interleaved\n4) hermitian planar")("outArrType", po::value<rocfft_array_type>(&outArrType)->default_value(rocfft_array_type_complex_interleaved), "Array type of output data:\n0) interleaved\n1) planar\n2) real\n3) hermitian interleaved\n4) hermitian planar");
