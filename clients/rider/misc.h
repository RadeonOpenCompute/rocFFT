...
void setupBuffers(std::vector<int> devices, const size_t bufferSizeBytesIn,
                  const unsigned numBuffersIn, void *buffersIn[],
                  const size_t bufferSizeBytesOut, const unsigned numBuffersOut,
                  void *buffersOut[]);
...
inline rocfft_status lib_V_Throw(rocfft_status res, const std::string &msg,
                                 size_t lineno, const std::string &fileName) {
  switch (res) {
...
#define HIP_V_THROW(_status, _message)                                         \
  hip_V_Throw(_status, _message, __LINE__, __FILE__)
#define LIB_V_THROW(_status, _message)                                         \
  lib_V_Throw(_status, _message, __LINE__, __FILE__)
