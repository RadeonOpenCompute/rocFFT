...
int main()
{
    ...
    const fftwf_plan fftwPlan = fftwf_plan_many_dft_r2c(rank, n, howmany,
        cpu_in_out, inembed, istride, idist,
        (fftwf_complex*)cpu_in_out, onembed, ostride, odist,
        flags);
    ...
    result = hipfftPlanMany(&hipForwardPlan, rank, n,
