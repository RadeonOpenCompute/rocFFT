...
__device__ void fft_2048(T* twiddles, T* lwb_in, T* lwb_out, real_type_t<T>* lds, const uint me, const ulong stride_in, const ulong stride_out)
{
...
template <typename T, StrideBin sb, int dir>
__device__ void fft_4096(T* twiddles, T* lwb_in, T* lwb_out, real_type_t<T>* lds, const uint me, const ulong stride_in, const ulong stride_out)
{
    T X0, X1, X2, X3, X4, X5, X6, X7;
