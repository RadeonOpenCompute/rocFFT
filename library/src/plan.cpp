    ...
    if (description != nullptr) {
        ...
        case rocfft_transform_type_complex_inverse: {
            if (placement == rocfft_placement_inplace) {
                ...
                if (((description->inArrayType == rocfft_array_type_complex_interleaved) || (description->inArrayType == rocfft_array_type_complex_planar))) {
                    if (!((description->outArrayType == rocfft_array_type_complex_interleaved) || (description->outArrayType == rocfft_array_type_complex_planar)))
                        return rocfft_status_invalid_array_type;
                } else
                    return rocfft_status_invalid_array_type;
            }
        ...
        case rocfft_transform_type_real_forward: {
            ...
            if (placement == rocfft_placement_inplace) {
                ...
                if (!((description->outArrayType == rocfft_array_type_hermitian_interleaved) || (description->outArrayType == rocfft_array_type_hermitian_planar)))
                    return rocfft_status_invalid_array_type;
            }
        } break;
        case rocfft_transform_type_real_inverse: {
            ...
            if (placement == rocfft_placement_inplace) {
                ...
                if (!((description->inArrayType == rocfft_array_type_hermitian_interleaved) || (description->inArrayType == rocfft_array_type_hermitian_planar)))
                    return rocfft_status_invalid_array_type;
            }
        } break;
        }

        if ((placement == rocfft_placement_inplace) && ((transform_type == rocfft_transform_type_complex_forward) || (transform_type == rocfft_transform_type_complex_inverse))) {
...
void TreeNode::TraverseTreeCollectLeafsLogicA(std::vector<TreeNode*>& seq, size_t& tmpBufSize, size_t& cmplxForRealSize, size_t& blueSize, size_t& chirpSize)
{
    if (childNodes.size() == 0) {
        ...
        if (obOut == OB_TEMP_CMPLX_FOR_REAL)
            cmplxForRealSize = (oDist * batch) > cmplxForRealSize ? (oDist * batch) : cmplxForRealSize;
        if (obOut == OB_TEMP)
