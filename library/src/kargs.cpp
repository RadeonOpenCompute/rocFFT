...
size_t *kargs_create(std::vector<size_t> length, std::vector<size_t> inStride,
                     std::vector<size_t> outStride, size_t iDist,
                     size_t oDist) {
  void *devk;
  ...
  hipMemcpy(devk, devkHost, 3 * KERN_ARGS_ARRAY_WIDTH * sizeof(size_t),
