...
template <typename T> __device__ T TW2step(const T *twiddles, size_t u) {
  ...
  while (u > 0) {
    i += 1;
    j = u & 255;
    result = lib_make_vector2<T>((result.x * twiddles[256 * i + j].x -
                                  result.y * twiddles[256 * i + j].y),
                                 (result.y * twiddles[256 * i + j].x +
                                  result.x * twiddles[256 * i + j].y));
    u >>= 8; // discard the lowest 8 bits
  }
...
template <typename T> __device__ T TW3step(const T *twiddles, size_t u) {
  size_t j = u & 255;
  T result = twiddles[j];
  ...
  result = lib_make_vector2<T>(
      (result.x * twiddles[256 + j].x - result.y * twiddles[256 + j].y),
      (result.y * twiddles[256 + j].x + result.x * twiddles[256 + j].y));

  u >>= 8;
  j = u & 255;
  result = lib_make_vector2<T>(
      (result.x * twiddles[512 + j].x - result.y * twiddles[512 + j].y),
      (result.y * twiddles[512 + j].x + result.x * twiddles[512 + j].y));
  return result;
}

template <typename T> __device__ void FwdRad2B1(T *R0, T *R1) {

  (*R1) = (*R0) - (*R1);
  (*R0) = 2.0 * (*R0) - (*R1);
}

template <typename T> __device__ void InvRad2B1(T *R0, T *R1) {

  (*R1) = (*R0) - (*R1);
  (*R0) = 2.0 * (*R0) - (*R1);
}

template <typename T> __device__ void FwdRad3B1(T *R0, T *R1, T *R2) {
...
template <typename T> __device__ void InvRad3B1(T *R0, T *R1, T *R2) {
...
template <typename T> __device__ void FwdRad4B1(T *R0, T *R2, T *R1, T *R3) {
...
template <typename T> __device__ void InvRad4B1(T *R0, T *R2, T *R1, T *R3) {
...
template <typename T>
__device__ void FwdRad8B1(T *R0, T *R4, T *R2, T *R6, T *R1, T *R5, T *R3,
                          T *R7) {
...
template <typename T>
__device__ void InvRad8B1(T *R0, T *R4, T *R2, T *R6, T *R1, T *R5, T *R3,
                          T *R7) {
...
template <typename T>
__device__ void FwdRad10B1(T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6,
                           T *R7, T *R8, T *R9) {

  real_type_t<T> TR0, TI0, TR1, TI1, TR2, TI2, TR3, TI3, TR4, TI4, TR5, TI5,
      TR6, TI6, TR7, TI7, TR8, TI8, TR9, TI9;
...
template <typename T>
__device__ void InvRad10B1(T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6,
                           T *R7, T *R8, T *R9) {
...
template <typename T>
__device__ void FwdRad16B1(T *R0, T *R8, T *R4, T *R12, T *R2, T *R10, T *R6,
                           T *R14, T *R1, T *R9, T *R5, T *R13, T *R3, T *R11,
                           T *R7, T *R15) {
  ...
  (*R8) = 2.0 * (*R8) - (*R12);
  (*R13) =
      ((*R9) - C8Q * (*R13)) - C8Q * lib_make_vector2<T>((*R13).y, -(*R13).x);
  (*R9) = 2.0 * (*R9) - (*R13);
  (*R14) = (*R10) + lib_make_vector2<T>(-(*R14).y, (*R14).x);
  (*R10) = 2.0 * (*R10) - (*R14);
  (*R15) =
      ((*R11) + C8Q * (*R15)) - C8Q * lib_make_vector2<T>((*R15).y, -(*R15).x);
  (*R11) = 2.0 * (*R11) - (*R15);

  (*R8) = (*R0) - (*R8);
  (*R0) = 2.0 * (*R0) - (*R8);
  (*R9) =
      ((*R1) - C16A * (*R9)) - C16B * lib_make_vector2<T>((*R9).y, -(*R9).x);
  res = (*R8);
  (*R1) = 2.0 * (*R1) - (*R9);

  (*R10) =
      ((*R2) - C8Q * (*R10)) - C8Q * lib_make_vector2<T>((*R10).y, -(*R10).x);
  (*R2) = 2.0 * (*R2) - (*R10);
  (*R11) =
      ((*R3) - C16B * (*R11)) - C16A * lib_make_vector2<T>((*R11).y, -(*R11).x);
  (*R3) = 2.0 * (*R3) - (*R11);

  (*R12) = (*R4) + lib_make_vector2<T>(-(*R12).y, (*R12).x);
  (*R4) = 2.0 * (*R4) - (*R12);
  (*R13) =
      ((*R5) + C16B * (*R13)) - C16A * lib_make_vector2<T>((*R13).y, -(*R13).x);
  (*R5) = 2.0 * (*R5) - (*R13);

  (*R14) =
      ((*R6) + C8Q * (*R14)) - C8Q * lib_make_vector2<T>((*R14).y, -(*R14).x);
  (*R6) = 2.0 * (*R6) - (*R14);
  (*R15) =
      ((*R7) + C16A * (*R15)) - C16B * lib_make_vector2<T>((*R15).y, -(*R15).x);
  (*R7) = 2.0 * (*R7) - (*R15);
...
template <typename T>
__device__ void InvRad16B1(T *R0, T *R8, T *R4, T *R12, T *R2, T *R10, T *R6,
                           T *R14, T *R1, T *R9, T *R5, T *R13, T *R3, T *R11,
                           T *R7, T *R15) {
