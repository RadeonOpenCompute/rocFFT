...
#define SR_COMP_BOTH 2 // real & imag
        ...
        size_t regC, size_t numB, size_t numPrev, std::string& passStr, bool isPrecallVector = false, bool oddt = false) const
    {
        ...
        if (numB && (numB % 2 == 0) && (regC == 1) && (numButterfly % 2 == 0) && (algLS % 2 == 0) && (flag == SR_WRITE) && (nextPass == NULL) && interleaved && (component == SR_COMP_BOTH) && linearRegs && enableGrouping && !fft_doPostCallback) {
...
public:
        ...
        bool gIn = false, bool gOut = false) const
    {
        ...
        if (name_suffix == "_sbcc")
            passStr += "const " + regB2Type + " *twiddles_large, "; //the blockCompute BCT_C2C algorithm use one more twiddle parameter
