...
template <typename T>
__global__ void complex2real_kernel(size_t input_size, size_t input_stride, size_t output_stride, T* input, size_t input_distance, real_type_t<T>* output, size_t output_distance)
{
...
template <typename T>
__global__ void hermitian2complex_kernel(size_t hermitian_size, size_t dim_0, size_t dim_1, size_t dim_2,
