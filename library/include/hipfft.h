...
typedef enum hipfftResult_t {
  ...
  HIPFFT_NOT_IMPLEMENTED =
      14, // Function does not implement functionality for parameters given.
...
DLL_PUBLIC hipfftResult hipfftPlan2d(hipfftHandle *plan, int nx, int ny,
                                     hipfftType type);

DLL_PUBLIC hipfftResult hipfftPlan3d(hipfftHandle *plan, int nx, int ny, int nz,
                                     hipfftType type);

DLL_PUBLIC hipfftResult hipfftPlanMany(hipfftHandle *plan, int rank, int *n,
                                       int *inembed, int istride, int idist,
                                       int *onembed, int ostride, int odist,
                                       hipfftType type, int batch);

DLL_PUBLIC hipfftResult
hipfftMakePlan1d(hipfftHandle plan, int nx, hipfftType type,
                 int batch, /* deprecated - use hipfftPlanMany */
                 size_t *workSize);

DLL_PUBLIC hipfftResult hipfftMakePlan2d(hipfftHandle plan, int nx, int ny,
                                         hipfftType type, size_t *workSize);

DLL_PUBLIC hipfftResult hipfftMakePlan3d(hipfftHandle plan, int nx, int ny,
                                         int nz, hipfftType type,
                                         size_t *workSize);

DLL_PUBLIC hipfftResult hipfftMakePlanMany(hipfftHandle plan, int rank, int *n,
                                           int *inembed, int istride, int idist,
                                           int *onembed, int ostride, int odist,
                                           hipfftType type, int batch,
                                           size_t *workSize);

DLL_PUBLIC hipfftResult hipfftMakePlanMany64(
...
DLL_PUBLIC hipfftResult hipfftGetSizeMany64(
    hipfftHandle plan, int rank, long long int *n, long long int *inembed,
    long long int istride, long long int idist, long long int *onembed,
    long long int ostride, long long int odist, hipfftType type,
    long long int batch, size_t *workSize);

DLL_PUBLIC hipfftResult hipfftEstimate1d(
    int nx, hipfftType type, int batch, /* deprecated - use hipfftPlanMany */
    size_t *workSize);

DLL_PUBLIC hipfftResult hipfftEstimate2d(int nx, int ny, hipfftType type,
                                         size_t *workSize);

DLL_PUBLIC hipfftResult hipfftEstimate3d(int nx, int ny, int nz,
                                         hipfftType type, size_t *workSize);

DLL_PUBLIC hipfftResult hipfftEstimateMany(int rank, int *n, int *inembed,
...
DLL_PUBLIC hipfftResult
hipfftGetSize1d(hipfftHandle plan, int nx, hipfftType type,
                int batch, /* deprecated - use hipfftGetSizeMany */
                size_t *workSize);

DLL_PUBLIC hipfftResult hipfftGetSize2d(hipfftHandle plan, int nx, int ny,
                                        hipfftType type, size_t *workSize);

DLL_PUBLIC hipfftResult hipfftGetSize3d(hipfftHandle plan, int nx, int ny,
                                        int nz, hipfftType type,
                                        size_t *workSize);

DLL_PUBLIC hipfftResult hipfftGetSizeMany(hipfftHandle plan, int rank, int *n,
                                          int *inembed, int istride, int idist,
                                          int *onembed, int ostride, int odist,
                                          hipfftType type, int batch,
                                          size_t *workSize);
...
DLL_PUBLIC hipfftResult hipfftSetAutoAllocation(hipfftHandle plan,
                                                int autoAllocate);

DLL_PUBLIC hipfftResult hipfftExecC2C(hipfftHandle plan, hipfftComplex *idata,
                                      hipfftComplex *odata, int direction);

DLL_PUBLIC hipfftResult hipfftExecR2C(hipfftHandle plan, hipfftReal *idata,
                                      hipfftComplex *odata);

DLL_PUBLIC hipfftResult hipfftExecC2R(hipfftHandle plan, hipfftComplex *idata,
                                      hipfftReal *odata);
